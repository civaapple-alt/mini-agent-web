<!-- Source: anthropics/knowledge-work-plugins/productivity/skills/memory-management/SKILL.md. External connectors and write actions are disabled in Mini Agent. -->
