<!-- Source: anthropics/knowledge-work-plugins/product-management/skills/write-spec/SKILL.md. External connectors and write actions are disabled in Mini Agent. -->
