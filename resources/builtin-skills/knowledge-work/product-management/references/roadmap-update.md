<!-- Source: anthropics/knowledge-work-plugins/product-management/skills/roadmap-update/SKILL.md. External connectors and write actions are disabled in Mini Agent. -->
