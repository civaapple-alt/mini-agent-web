<!-- Source: anthropics/knowledge-work-plugins/product-management/skills/synthesize-research/SKILL.md. External connectors and write actions are disabled in Mini Agent. -->
