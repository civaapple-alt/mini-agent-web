<!-- Source: anthropics/knowledge-work-plugins/product-management/skills/product-brainstorming/SKILL.md. External connectors and write actions are disabled in Mini Agent. -->
